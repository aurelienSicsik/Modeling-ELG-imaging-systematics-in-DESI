...
filename=data_path+"maps-data/229328.csv"
...
t = clean_sample(t)
t.write(output_path+"HSC_cleaned_truth_catalog.csv", overwrite=True)

t = extract_truth_sample(t, ratio_density)
print(str(len(t)) + " objects in the truth sample")

t.write(output_path+"HSC_truth_sample.csv", overwrite=True)
